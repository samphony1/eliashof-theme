...
- **Aktuelles Page Setup & Menu Link updates**: Created and initialized the page (ID 251, slug `/aktuelles/`) with featured image 198 (school yard). Updated primary navigation menu item ID 97 andfallback menu callback to point to the new page instead of the anchor `/#aktuelles`.
