...
<div class="wp-block-group alignfull eliashof-section eliashof-aktuelles has-background" style="background-color:#8cc8d1;padding-top:clamp(60px,8vw,100px);padding-bottom:clamp(60px,8vw,100px)">
	...
	<!-- wp:heading {"level":2,"textAlign":"center","style":{"typography":{"fontFamily":"'Neucha', cursive","fontSize":"50px","letterSpacing":"2.5px","lineHeight":"1.2"},"color":{"text":"#241f21"},"spacing":{"margin":{"top":"0","bottom":"52px"}}}} -->
	<h2 class="wp-block-heading has-text-align-center" style="color:#241f21;font-family:'Neucha',cursive;font-size:50px;letter-spacing:2.5px;line-height:1.2;margin-top:0;margin-bottom:52px">Aktuelles</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-query eliashof-aktuelles-carousel">
		...
		<!-- wp:post-template {"templateLock":"all","layout":{"type":"default"}} -->
			...
			<div class="wp-block-group is-layout-flex is-vertical is-content-justification-left is-align-items-center wp-block-group-is-layout-flex" style="--wp--style--block-gap:33px;width:391px;max-width:100%">

				<!-- wp:post-title {"level":3,"textAlign":"center","isLink":false,"style":{"typography":{"fontFamily":"'Neucha', cursive","fontSize":"40px","letterSpacing":"0.05em","lineHeight":"1.1"},"color":{"text":"#000000"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} /-->
