...
<div id="hero-blog-foerderverein" class="wp-block-group alignfull eliashof-hero-blog-schule bg-graph-blue eliashof-hero-blog-foerderverein">
	...
	<div class="wp-block-group eliashof-hero-blog-schule-container">
		...
		<div class="wp-block-group eliashof-hero-blog-schule-content-col">
			...
			<h1 class="wp-block-heading eliashof-hero-blog-schule-title">UNSER FÖRDERVEREIN</h1>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group eliashof-hero-blog-schule-illustration eliashof-hero-foerderverein-balloon">
			<!-- wp:image {"sizeSlug":"full","linkDestination":"none","url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Balloon-cropped.svg","className":"eliashof-balloon-desktop"} -->
			<figure class="wp-block-image size-full eliashof-balloon-desktop"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Balloon-cropped.svg" alt="Balloon" /></figure>
			<!-- /wp:image -->
