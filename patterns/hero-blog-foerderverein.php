 ...
 * Description: Editable header section for the Förderverein page with featured image on the left, custom heading on the right, and illustration.
 */
?>
<!-- wp:group {"align":"full","anchor":"hero-blog-foerderverein","className":"eliashof-hero-blog-schule bg-graph-yellow eliashof-hero-blog-foerderverein","layout":{"type":"constrained"}} -->
<div id="hero-blog-foerderverein" class="wp-block-group alignfull eliashof-hero-blog-schule bg-graph-yellow eliashof-hero-blog-foerderverein">
	...
	<div class="wp-block-group eliashof-hero-blog-schule-container">
		...
		<div class="wp-block-group eliashof-hero-blog-schule-content-col">
			...
			<h1 class="wp-block-heading eliashof-hero-blog-schule-title">FÖRDERVEREIN</h1>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
